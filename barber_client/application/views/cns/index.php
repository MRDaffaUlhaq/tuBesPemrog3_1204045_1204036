                ...
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="card-title">
                            <a class="btn bg-gradient-primary mb-4" href="<?= base_url('cns/add/') ?>"><i class="fa fa-plus-square mr-1"></i>
                                Tambah Data
                            </a>
                        </div>
                            ...
                            <table class="table table-hover align-items-center mb-2" id="tableService">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-primary  font-weight-bolder opacity-7 ps-2">NAMA PELANGGAN</th>
                                        <th class="text-center text-uppercase text-primary  font-weight-bolder opacity-7">RATE</th>
